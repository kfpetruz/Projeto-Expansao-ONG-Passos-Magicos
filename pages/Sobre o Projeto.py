...
st.markdown(f'<p style="{fonte_escura}"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 20px">&#8226;</span>&nbsp; Extrair insights dos dados históricos de alunos;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 20px">&#8226;</span>&nbsp; Apresentar fatores de sucesso;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 20px">&#8226;</span>&nbsp; Apresentar o impacto social da ONG na cidade onde atua;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 20px">&#8226;</span>&nbsp; Criar visualizações impactantes para os dados;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 20px">&#8226;</span>&nbsp; Promover transparência e conscientização;<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 20px">&#8226;</span>&nbsp; Propôr plano de ampliação da atuação da ONG;</p>', unsafe_allow_html = True)
# st.markdown(f'<p style=" {fonte_escura}"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 20px">&#8226;</span>&nbsp; Apresentar fatores de sucesso;</p>', unsafe_allow_html = True)
# st.markdown(f'<p style=" {fonte_escura}"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 20px">&#8226;</span>&nbsp; Apresentar o impacto social da ONG na cidade onde atua;</p>', unsafe_allow_html = True)
# st.markdown(f'<p style=" {fonte_escura}"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 20px">&#8226;</span>&nbsp; Criar visualizações impactantes para os dados;</p>', unsafe_allow_html = True)
# st.markdown(f'<p style= "{fonte_escura}"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 20px">&#8226;</span>&nbsp; Promover transparência e conscientização;</p>', unsafe_allow_html = True)
# st.markdown(f'<p style= "{fonte_escura}"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 20px">&#8226;</span>&nbsp; Propôr plano de ampliação da atuação da ONG;</p>', unsafe_allow_html = True)
