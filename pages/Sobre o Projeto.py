...
st.markdown(f'<p style= "{fonte_escura}"> - Promover transparência e conscientização;</p>', unsafe_allow_html = True)
st.markdown(f'<p style= "{fonte_escura}"> - Propôr plano de ampliação da atuação da ONG;</p>', unsafe_allow_html = True)
